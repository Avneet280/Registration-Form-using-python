...
nameEntry=Entry(root,textvariable=nameValue,width=20,bd=2,font=20)
phoneEntry=Entry(root,textvariable=phoneValue,width=20,bd=2,font=20)
genderEntry=Entry(root,textvariable=genderValue,width=20,bd=2,font=20)
...
Button(text="Register",font=20,width=11,height=1,command=register).place(x=250,y=380)
